...
/**
 * SimpleParser クラス
 * SQLコマンド文字列を解析してトークンに分割し、
 * 最初のトークンをコマンドとして抽出する機能を提供する
 */
final public class SimpleParser {
    ...
    /**
     * SQLコマンド文字列をトークンに分割する
     * 空白で区切られたトークンに分割し、最初のトークンを小文字に変換する
     * 
